...
mysql --defaults-file=~/.lsst/dbAuth-metaServ.txt -e "drop database metaServ_core"
mysql --defaults-file=~/.lsst/dbAuth-metaServ.txt --database="" -e "create database metaServ_core"
